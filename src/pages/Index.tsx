...
import espaluzFaceAvatar from '@/assets/espaluz-face-avatar.jpg';
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <section className="container mx-auto px-4 pt-20 pb-6 text-center bg-gradient-magical rounded-2xl shadow-vibrant">
        <div className="mx-auto w-32 h-32 mb-4 flex items-center justify-center">
          <img src={espaluzFaceAvatar} alt="EspaLuz Avatar" className="w-full h-full rounded-full border-4 border-primary shadow-glow object-contain bg-white" />
        </div>
