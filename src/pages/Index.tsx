  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
      ...
      <section className="container mx-auto px-4 pt-20 pb-8 text-center bg-gradient-to-br from-orange-100 via-pink-100 to-purple-100 rounded-3xl shadow-xl">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold mb-6 leading-tight bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 bg-clip-text text-transparent drop-shadow px-4">
